...
public final record TickTime(
     ...
     * {@code < 0} if the tick started before the scheduled tick time.
     */
    ...
    /**
     * The difference from the end tick time and the start tick time. Always {@code >= 0} (unless nanoTime is just wrong).
     */
